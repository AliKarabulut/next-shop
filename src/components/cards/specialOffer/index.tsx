  ...
  return (
    <div
      ...
      <div className="flex w-full items-center justify-between">
        ...
        <div className="flex h-20 w-20 shrink-0 flex-col items-center justify-center rounded-full bg-yellow">
      ...
      <div className="flex flex-col items-center gap-3">
        <Link href={production.url} className="text-sm font-bold text-inherit text-lightDark hover:text-yellow">
          {production.name}
        </Link>
