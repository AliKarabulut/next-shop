...
const ActionIcon = ({ children, quantity, price }: ActionIconProps) => {
  return (
    <div className="actionIcon group relative cursor-pointer duration-300 flex gap-2 items-center">
      {children}
      {quantity && (
        <div className="rounded-full w-5 h-5 bg-yellow absolute left-3.5 -bottom-2.5 text-sm flex items-center justify-center group-hover:opacity-50 duration-300 font-medium">
